    ...
    <div className="min-h-screen">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        ...
        <FadeIn delay={500} className="mt-16 max-w-4xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-700 bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-900 aspect-video flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-sm">App screenshot coming soon</p>
            </div>
          </div>
        </FadeIn>
      </section>
